...
public class SkinEngine {
  ...
  private DrawableArrPreloadIntercepter drawableArrPreloadIntercepter;
  private DrawableColorPreloadIntercepter drawableColorPreloadIntercepter;
  ...
  public void addResource(Resources res,int resId) {
    drawableColorPreloadIntercepter.add(res,resId);
  }
  /**
   * start load skin
   */
