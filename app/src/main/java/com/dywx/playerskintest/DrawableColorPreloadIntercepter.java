...
public class DrawableColorPreloadIntercepter extends LongSparseArray<ConstantState> {
  ...
  public DrawableColorPreloadIntercepter(SkinEngine skinEngine, LongSparseArray<ConstantState> preloadCache) {
  ...
  public ConstantState get(long key) {
    if ((Integer) mKeyToResourcesId.get(key) == null) {
      return (ConstantState) mOldPreloadCache.get(key);
    }
