...
public class DrawablePreloadIntercepter extends LongSparseArray<Drawable.ConstantState> {
  ...
  public DrawablePreloadIntercepter(SkinEngine skinEngine,LongSparseArray<Drawable.ConstantState> preloadCache) {
  ...
  public ConstantState get(long key) {
    if ((Integer) mKeyToResourcesId.get(key) == null) {
      return (Drawable.ConstantState) mOldPreloadCache.get(key);
    }
